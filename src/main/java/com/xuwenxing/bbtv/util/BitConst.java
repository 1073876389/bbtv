...
public class BitConst {
     ...
     * 验证码有效期
     */
    public static final long CODE_ALIVE_TIME = 5;
    /**
     * 验证码发送的间隔时间
     */
    public static final long MESSAGE_CANT_TIME = 90;
    /**
     * 邮箱有效期
     */
    public static final long EMAIL_ALIVE_TIME = 5;
    /**
     * 郵箱主題
     */
    public static final String SUBJECTTITLE = "這是一封驗證郵件";
    /**
     * 材料分数
     */
    public static final int CREDITBORROWSCORE = 30;
    // --------------------还款类型---------------------------
    ...
    public final static int BIDREQUEST_TYPE_EXPBID = 1; // 系统体验标
    // ---------------------借款状态---------------------------
    ...
    public static final BigDecimal MONEY_WITHDRAW_CHARGEFEE = new BigDecimal(
            "2.0000");// 系统提现手续费
    public static final BigDecimal MONEY_EXPBIDREQUEST = new BigDecimal("500.0000");//注册的体验金
    ...
    /**============体验金相关=============*/
    public final static int EXPACCOUNT_ACTIONTYPE_FREEZD = 1;//体验金流水类型
    public final static int EXPMONEY_TYPE_REGISTER = 1;//体验金发放类型
    /** =========还款状态=============== */
